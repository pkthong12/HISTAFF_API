...
namespace API.All.DbContexts
{
    ...
    public class InsuranceDbContext : DbContextBase
    {
        public InsuranceDbContext(IConfiguration config, DbContextOptions<InsuranceDbContext> options, IHttpContextAccessor accessor, IOptions<AppSettings> appSettings)
        ...
        public DbSet<HU_COMMEND_EMP> CommendEmps { get; set; }
